            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block user-dropdown">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        ...
                        @elseauth()
                            <span class="d-none d-xl-inline-block ms-1">Nihad</span>
                        @endauth
        ...
        <div data-simplebar class="h-100">
            ...
            <div class="user-profile text-center mt-3">
                ...
                <div class="mt-3">
                    ...
                    @elseauth()
                        <h4 class="font-size-16 mb-1">Nihad</h4>
                    @endauth
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="./../../../dashboard/doctors" class=" waves-effect">
                    ...
                    <li>
                        <a href="./../../../dashboard/patients" class="has-arrow waves-effect">
                    ...
                    <li>
                        <a href="./../../../dashboard/appointments" class="has-arrow waves-effect">
                            <i class="ri-mail-send-line"></i>
                            <span>RDVs</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
        ...
        <div class="main-content">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © Nihad.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Crafted with <i class="mdi mdi-heart text-danger"></i> by Nihad
                            </div>
                        </div>
                    </div>
                </div>
